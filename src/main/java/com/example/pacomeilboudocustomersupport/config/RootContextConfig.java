...
public class RootContextConfig implements TransactionManagementConfigurer {
    ...
    public static DataSource dataSource() {
        ...
        dataSource.setPassword("Omaha@1234");
        dataSource.setUrl("jdbc:mysql://localhost:3306/customersupport_db");
    ...
    public static LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.pacomeilboudocustomersupport.entities");
